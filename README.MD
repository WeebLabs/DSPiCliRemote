...
The **Optical** button runs a script of your choice. While running, the button shows On. 
...
If none of those are found the default is set to run Play -d for Mac OSX. See set_str.
