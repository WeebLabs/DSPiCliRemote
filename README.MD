...
#### Note: this now uses .NET 8 rather than .NET 10 since the client app was removed.
...
The **CLI** button switches to the CLI mode to let you type commands, such as set_str.
