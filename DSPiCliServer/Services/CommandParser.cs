    ...
    private static string ProcessCommand(string input)
    {
        ...
        try
        {
            return command switch
            {
                ...
                "help" => "Available commands: ping, time, date, help, hello, get_vol, set_vol <db>, get_bypass, set_bypass <0/1>, get_loudness, set_loudness <0/1>, get_leveling, set_leveling <0/1>, get_crossfeed, set_crossfeed <0/1>, get_samplerate, get_deviceid, get_activepreset, get_presets, set_preset, get_str, set_str <val>, run_str, kill_str, is_running",
